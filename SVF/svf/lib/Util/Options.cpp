...
const Option<bool> Options::NPDCheck(
    "npd", "Null Pointer Dereference Detection in Saber", false);
const Option<bool> Options::UAFCheck(
    "uaf", "Use After Free Detection in Saber", false);
...
const Option<bool> Options::RunUncallFuncs(
    "run-uncall-fun","Analyze uncalled root functions (for library bitcode)",false);
